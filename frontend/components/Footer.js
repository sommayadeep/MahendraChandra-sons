...
const Footer = () => {
  ...
  const footerLinks = {
    shop: [
      ...
      { name: 'Trolley Luggage', href: '/shop?category=trolley-luggage' },
  ...
  return (
    <footer className="bg-luxury-dark border-t border-gray-800">
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-2">
              <img
                ...
                className="w-16 h-16 rounded-sm object-cover border border-gold-500/70"
              />
              <div>
                <h3 className="font-serif text-xl text-white">Mahendra Chandra</h3>
                <p className="text-xs text-gold-500 tracking-widest">& SONS</p>
              </div>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              Premium bags and luggage for the discerning buyer. Crafted with excellence since generations.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400 text-sm">
              <li className="flex items-start space-x-2">
                ...
                <span>H.G.B Road, Agartala, Tripura, India</span>
              </li>
              <li className="flex items-center space-x-2">
                ...
                <span>mahendrachandra.sons@gmail.com</span>
              </li>
              <li className="flex items-center space-x-2">
                <svg className="w-5 h-5 text-gold-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span>6909790275</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-500 text-sm">
              &copy; {currentYear} Mahendra Chandra & Sons. All rights reserved.
            </p>
            <div className="flex items-center space-x-2">
              <span className="text-gray-500 text-sm">Powered by</span>
              <span className="text-gold-500 font-serif">Luxury</span>
            </div>
          </div>
        </div>
      </div>
